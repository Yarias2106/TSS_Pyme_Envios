...
class Empleado(models.Model):
    ...
    diasTrabajados = models.IntegerField(max_length=4, default=0)
    horasTrabajadas = models.IntegerField(max_length=4, default=0)
    salJorNorm = models.DecimalField(max_digits=6, decimal_places=2, default=0.00)
    salHorasExtra = models.DecimalField(max_digits=6, decimal_places=2, default=0.00)
    salFinSemana = models.DecimalField(max_digits=6, decimal_places=2, default=0.00)
    pedidosTrabajados = models.IntegerField(max_length=4, default=0)
...
class Pedido(models.Model):
   ...
   pagoxHora = models.DecimalField(max_digits=6, decimal_places=2, default=0.00)
